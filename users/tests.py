...
class RegisterTest(TestCase):
    def test(self):
        ...
        response2 = client.post('/register/', {'username': 'user3', 'email': 'j@gmail.com', 'password1': 'yuio1234',
                                               'password2': 'yuio1234'})
        ...
        response4 = client.post('/register/', {'username': 'user3', 'email': 'j2@gmail.com', 'password1': 'yuio1234',
                                               'password2': 'yuio1234'})
